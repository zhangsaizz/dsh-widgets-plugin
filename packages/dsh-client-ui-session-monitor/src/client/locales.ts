...
export const zh: Record<SessionMonitorKey, string> = {
  ...
  notifyCurrentDesc: '当前会话完成一轮时也提醒（默认关：你正在看它，无需再弹提醒）',
...
export const en: Record<SessionMonitorKey, string> = {
  ...
  notifyCurrentDesc: 'Also notify when the current session finishes (off by default — you are already looking at it)',
